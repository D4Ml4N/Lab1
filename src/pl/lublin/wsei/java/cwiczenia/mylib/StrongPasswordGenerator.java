...
public class StrongPasswordGenerator {
    public StrongPasswordGenerator(int i, boolean b, boolean b1, boolean b2, boolean b3, String s) {
    ...
    public static void Generate(int dlugosc, boolean maleLitery, boolean wielkieLitery, boolean cyfry,
